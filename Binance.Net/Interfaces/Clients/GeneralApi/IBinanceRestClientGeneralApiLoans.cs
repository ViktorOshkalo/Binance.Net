...
namespace Binance.Net.Interfaces.Clients.GeneralApi
{
    ...
    public interface IBinanceRestClientGeneralApiLoans
    {
        ...
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BinanceCryptoLoanIncome>>> GetIncomeHistoryAsync(string? asset = null, LoanIncomeType? type = null, DateTime? startTime = null, DateTime? endTime = null, int? limit = null, long? receiveWindow = null, CancellationToken ct = default);
